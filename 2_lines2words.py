...
def splitImg(imgPath):
    ...
    chars = findChars(binary_img, img.shape[1])
    ...
    for char in chars:
        ...
        cv2.imwrite(os.path.join(saveFilePath, f"{file_name}img{charCount}.png"), char)
        charCount += 1
...
if __name__ == "__main__":
    folder_path = './dataset/1000000000'  # 请替换为你的文件夹路径
